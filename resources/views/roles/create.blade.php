...
<div class="content">
    <div class="card card-chart border border border-info">
        ...
        <h5 class="card-header text-left btn-info disabled">Crear Nuevo Rol</h5>
        <div class="card">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            <b for="inputEmail4"class="text-dark">Nombre del Rol</b>
                               <input type="text" class="form-control" name="name" placeholder="Ingrese Nombre del Rol" value="{{old('name')}}" autofocus >                           
                               @if($errors-> has('name'))
