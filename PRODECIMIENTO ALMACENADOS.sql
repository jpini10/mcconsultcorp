CREATE PROCEDURE Sp_SeleccionarProductosPorEmpresaYSucursal( IN vIdEmpresa INT ,IN vIdSucursal INT, IN vIdLote INT, IN vCondicion INT)
BEGIN
...
IF CantProductos<CantEmpleados THEN 
SET CanMostrar=1;
ELSE 
